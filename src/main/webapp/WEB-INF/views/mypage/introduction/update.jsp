...
function introduction() {
	...
	$.ajax({
        url: "/mypage/introduction/update",
        type: "POST",
        traditional : true,
        data: {
        	introduction_no : ${introduction.introduction_no},
	...
	<div class="bottom_container">
		...
		<div class="info_container" style="margin-left: 250px; width: 940px;">
			...
			<div id="form_Overseas_Experience">
				<h4 class="head">자기소개서 작성</h4>
					<div class="form" id="div_Introduction">
						<div class="new">
							<div class="row">
								<div class="info_form school title" style="width: 100%;">
									<input type="text" name="introduction_title" placeholder="제목" value="${introduction.introduction_title }">
								</div>
							</div>
							<div class="row">
								<div class="info_form school question" style="width: 100%;">
									<input type="text" name="introduction_question" placeholder="질문" value="${introduction.introduction_question }">
								</div>
							</div>
							<div class="row content" style="height: 300px;">
								<textarea class="textarea_content" placeholder="내용" name="introduction_content">${introduction.introduction_content }</textarea>
							</div>
						</div>
			...
			<div style="float: right;">
				<button type="button" class="btn btn-default"onclick="submit();">수정완료</button>
			</div>
		</div>
