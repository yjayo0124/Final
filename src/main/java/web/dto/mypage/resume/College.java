...
public class College {
	...
	public String toString() {
		return "College [resume_no=" + resume_no + ", school_classification=" + school_classification
				+ ", school_name=" + school_name + ", admission_date=" + admission_date + ", graduation_date="
				+ graduation_date + ", graduation_status=" + graduation_status + ", major_name=" + major_name
				+ ", credit=" + credit + ", total_score=" + total_score + ", transfer_status=" + transfer_status
				+ ", sub_major=" + sub_major + ", sub_major_status=" + sub_major_status + ", sub_major_name="
				+ sub_major_name + ", graduation_thesis_status=" + graduation_thesis_status
